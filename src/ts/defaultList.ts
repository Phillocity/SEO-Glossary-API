export const defaultList: object[] = [
  ...
  },
  {
    ...
    term: "broken link",
    description:
      "A broken link is a link on your site that points to a non-existent (or",
  },
  {
  ...
  },
  {
    ...
    description:
      "The ratio of visits to conversions. Conversion rate answershow many of my website visitors are filling out my forms, calling, signing up for my newsletter, etc.?",
  },
  {
  ...
  },
  {
    ...
    term: "da",
    description:
      "Domain Authority (DA) is a metric used to predict a domain’s ranking ability; best used as a comparative metric (ex comparing a website’s DA score to that of itsdirect competitors).",
  },
  {
    _id: "6311f752034582cf927553ea",
    term: "deindexed",
    description:
      "When a URL, section of URLs, or an entire domain has been removed from a search engine index. This can happen for a number of reasons, such as when a website receives a manual penalty for violatingGoogle’s quality guidelines.",
  },
  {
  ...
  },
  {
    ...
    term: "dns",
    description:
      "A Domain Name Server (DNS) allows domain names to be linked to IP addresses (ex '127.0.0.1'). DNS essentially translates domain names into IP addresses so that browsers can load the page’s resources.",
  },
  {
  ...
  },
  {
    ...
    term: "editorial link",
    description:
      "Link that points to your site (that you didn’t ask or payfor.)",
  },
  {
  ...
  },
  {
    ...
    description:
      "SERP feature that provides information about the main subject of thequery.",
  },
  {
  ...
  },
  {
    ...
    term: "google penguin",
    description:
      "Algorithm update released in 2012 by Google to downgrade sites that engaged in manipulative link schemesand keyword stuffing.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Algorithm update released in 2012 by Google to downgrade web pages with too many ads at thetop.",
  },
  {
    _id: "6311f752034582cf9275541e",
    term: "google webmaster guidelines",
    description:
      "Best practices from Google to help them find, index, and rank yoursite.",
  },
  {
  ...
  },
  {
    ...
    term: "h1 tag",
    description:
      "HTML heading that’s most commonly used to mark up a web pagetitle.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Algorithm adopted by Google in 2003 to identify authoritative web pages torank.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Full-screen interactive ads that cover the interface of the website orapp.",
  },
  {
    _id: "6311f752034582cf9275543b",
    term: "ip address",
    description:
      "An internet protocol (IP) address is a string of numbers that’s unique to each specific website. We assign domain names to IP addresses because they’re easier for humans to remember but the internet needs these numbers to find websites.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Keyword cannibalization happens when a single website unintentionally targets the same keyword across multiple posts orpages.",
  },
  {
  ...
  },
  {
    ...
    description:
      "A query in which the searcher is trying to get to a certain location, such as the BBC blog (query = 'bbc blog').",
  },
  {
  ...
  },
  {
    ...
    term: "url folders",
    description:
      "Sections of a website occurring after the TLD ('.com'), separated by slashes ('/'). For example, in 'example.com/blog' we could say '/blog' is a folder.",
  },
  {
